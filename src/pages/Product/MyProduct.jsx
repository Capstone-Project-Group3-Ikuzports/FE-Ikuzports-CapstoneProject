...
import { Box, Divider, Flex, FormLabel, Input, Stack, Heading, Spacer, InputGroup, InputLeftAddon, ModalBody, ModalCloseButton, ModalContent, ModalFooter, ModalHeader, ModalOverlay, Select, SimpleGrid, Text, Textarea, useDisclosure } from "@chakra-ui/react";
      ...
      <Box p='8' px={'10%'} w={'100vw'} h={'100%'}  overflowX='hidden'>
        ...
        <CardProduct key={item.id} image={item.product_image != undefined ? item.product_image[0].url : "https://www.hostpapa.com/knowledgebase/wp-content/uploads/2018/04/1-13.png"}>
            ...
            <Flex>
                ...
                <Spacer></Spacer>
                <BsFillTrashFill onClick={() => DellProduct(item.id)} size={25}color={'red'}/>
            </Flex>
            <Text>
                {item.description}
            </Text>
